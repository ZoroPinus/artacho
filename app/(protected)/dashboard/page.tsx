...
const DashboardPage = () => {
  ...
  const fetchMembers = async () => {
    try {
      const res = await members(); // Assuming `members` is an async function that fetches the data
      
      // Check if the response contains an array of members
      if (Array.isArray(res)) {
        ...
        // Iterate over the fetched members array and count members by gender
        res.forEach(member => {
