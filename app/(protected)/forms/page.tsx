          ...
          <TabsContent value="overview" className="space-y-4">
            <div className="grid grid-cols-3 gap-4 h-screen">
              <div className="overflow-y-auto col-span-3">
                {/* CARDS */}
                <div className="grid gap-10 md:grid-cols-4 lg:grid-cols-3 p-10 ">
                  <Card
                    className="h-72 flex justify-center flex-col items-left transition-transform duration-300 transform hover:scale-105 hover:bg-gradient-to-r from-sky-200 from-30% via-green-200 via-60% to-emerald-200 to-90%"
